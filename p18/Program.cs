...
namespace p17_repasopoo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(File.Exists(arch))  {
                Console.WriteLine($"El archivo {arch} existe en la ruta actual, CARGANDO datos .....");
                mired = new Red();
                Utils.LeerXml(arch, ref mired);
            } else {
                Console.WriteLine($"El archivo {arch} NO existe en la ruta actual, INICIALIZADO datos ...");
        ...
        public static void Inicializa(ref Red mired) {
            // Inicializar datos
        ...
        public static void Reporte(Red mired) {
            // Reporte 
